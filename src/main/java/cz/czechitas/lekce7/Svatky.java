...
public class Svatky {
    ...
    public Svatky() {
        ...
        svatky.put("Klaudie", MonthDay.of(5, 5)); //5
        ...
        svatky.put("Ctibor", MonthDay.of(5, 9)); // 10
        ...
        svatky.put("Servác", MonthDay.of(5, 13)); // 15
        ...
        svatky.put("Nataša", MonthDay.of(5, 18)); // 20
        ...
        svatky.put("Vladimír", MonthDay.of(5, 23)); // 25
        ...
        svatky.put("Filip", MonthDay.of(5, 26)); // 30
        ...
        svatky.put("Maxim", MonthDay.of(5, 29)); // 35
        svatky.put("Ferdinand", MonthDay.of(5, 30));
        svatky.put("Kamila", MonthDay.of(5, 31)); //37
    }
